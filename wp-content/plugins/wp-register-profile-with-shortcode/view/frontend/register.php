<form name="register" id="register" method="post" action="" <?php do_action('wprp_register_form_tag');?>>
  ...
  <div class="reg-form-group">
    ...
    <input type="text" class="field-main" name="user_login" value="<?php echo sanitize_text_field(@$_SESSION['wp_register_temp_data']['user_login']); ?>" required title="<?php _e('Please enter username', 'wp-register-profile-with-shortcode');?>" placeholder="<?php _e('Username', 'wp-register-profile-with-shortcode');?>" <?php do_action('wprp_user_login_field');?>/>
  </div>
  <?php }?>
    ...
    <?php if ($wprp_p->is_field_enabled('lastname_in_registration')) {?>
        <div class="reg-form-group">
            ...
            <input type="text" class="field-main" name="last_name" value="<?php echo sanitize_text_field(@$_SESSION['wp_register_temp_data']['last_name']); ?>" <?php echo $wprp_p->is_field_required('is_lastname_required'); ?> title="<?php _e('Please enter last name', 'wp-register-profile-with-shortcode');?>" placeholder="<?php _e('Last Name', 'wp-register-profile-with-shortcode');?>" <?php do_action('wprp_last_name_field');?>/>
        </div>
    <?php }?>
  <div class="reg-form-group">
    <label for="useremail">
      <?php _e('Email', 'wp-register-profile-with-shortcode');?>
    </label>
    <input type="email" class="field-main" name="user_email" value="<?php echo sanitize_text_field(@$_SESSION['wp_register_temp_data']['user_email']); ?>" required title="<?php _e('Please enter email', 'wp-register-profile-with-shortcode');?>" placeholder="<?php _e('Email', 'wp-register-profile-with-shortcode');?>" <?php do_action('wprp_user_email_field');?>/>
  </div>
  ...
  <div class="reg-form-group">
    ...
    <input type="password" class="field-main" name="new_user_password" required placeholder="<?php _e('Password', 'wp-register-profile-with-shortcode');?>" title="<?php _e('Please enter password', 'wp-register-profile-with-shortcode');?>" <?php do_action('wprp_new_user_password_field');?>/>
  </div>
  <div class="reg-form-group">
    <label for="retypepassword">
      <?php _e('Retype Password', 'wp-register-profile-with-shortcode');?>
    </label>
    <input type="password" class="field-main" name="re_user_password" required title="<?php _e('Please re-enter password', 'wp-register-profile-with-shortcode');?>" placeholder="<?php _e('Retype Password', 'wp-register-profile-with-shortcode');?>" <?php do_action('wprp_re_user_password_field');?>/>
  </div>
  <?php }?>
  ...
  <div class="reg-form-group">
    ...
    <textarea class="field-main" name="description" <?php echo $wprp_p->is_field_required('is_userdescription_required'); ?> title="<?php _e('Please enter about', 'wp-register-profile-with-shortcode');?>" <?php do_action('wprp_description_field');?>><?php echo sanitize_text_field(@$_SESSION['wp_register_temp_data']['description']); ?></textarea>
  </div>
  <?php }?>
  ...
  <div class="reg-form-group">
    ...
    <input type="text" class="field-main" name="user_captcha" autocomplete="off" required title="<?php _e('Please enter captcha', 'wp-register-profile-with-shortcode');?>" <?php do_action('wprp_user_captcha_field');?>/>
  </div>
  <?php }?>
  <?php $default_registration_form_hooks == 'Yes' ? do_action('register_form') : '';?>
  <?php do_action('wp_register_profile_form');?>
  <div class="reg-form-group">
    <input name="register" type="submit" value="<?php _e('Sign Up', 'wp-register-profile-with-shortcode');?>" <?php do_action('wprp_register_form_submit_tag');?>/>
  </div>
</form>
