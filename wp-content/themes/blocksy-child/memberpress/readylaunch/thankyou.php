...
<div class="mepr-signup-form mepr-form">
    <div class="mepr-checkout-container thankyou mp_wrapper alignwide">
        ...
        <div class="invoice-wrapper thankyou">
            <img class="thanks_logo" alt="Thank you"
                src="<?= get_stylesheet_directory_uri() . '/images/thanks/robot-thanks.png' ?>" />

            <h2 class="thanks_heading">Thank you!</h2>
            ...
            <?php else : ?>
                ...
                */ ?>
                ...
                <div class="mepr-order-no">
                    ...
                    <p class="">Order ID: <?= esc_html($trans_num); ?></p>
                </div>
                ...
                */ ?>
                ...
                if (class_exists('MePdfInvoicesCtrl')) {
                    $downloadLink = MeprUtils::admin_url(
                        'admin-ajax.php',
                    ...
                    ?>
                    <a class="mepr-invoice-print mepr-button" href="<?= $downloadLink ?>" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor"
                            class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <?php echo esc_html_x('Print', 'ui', 'memberpress'); ?>
                    </a>
                <?php } */ ?>
                ...
                <?php
                    ...
                    $product = $txn->product();
                    $period_type = ucfirst($product->period_type);
                ?>
                <div class="thanks-grid">
                    <div class="_col _planName"><?= $product->post_title ?></div>
                    <div class="_col _amount"><?= $amount ?></div>
                    <div class="_col _planName"><?= $amount . " / " . $period_type ?></div>
                </div>
            ...
            <p>
                <a class="thanks-backHome" href="<?php echo esc_url(home_url()); ?>">Back to Home</a>
            </p>
