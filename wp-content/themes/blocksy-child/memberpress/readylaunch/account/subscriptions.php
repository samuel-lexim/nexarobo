...
?>
    ...
    <h1 class="mepr_page_header">My Subscription</h1>
        ...
        >
            ...
            foreach ($subscriptions as $s) :
                ...
                if ($txn != false && $txn instanceof MeprTransaction && $txn->is_sub_account()) {
                    ...
                    if (
                    ...
                    } else if (!$is_sub && !empty($prd->ID)) {
                        if ($prd->is_one_time_payment() && $prd->is_renewable() && $prd->is_renewal()) {
                            ?>
                            <a href="<?php echo $prd->url(); ?>"
                                class="mepr-account-row-action mepr-account-renew"><?php _ex('Renew', 'ui', 'memberpress'); ?></a>
                            <?php
                        }
                        ...
                        if ($txn != false && $txn instanceof MeprTransaction && $group !== false && strpos($s->active, 'mepr-inactive') === false) {
                            ...
                            strpos($s->active, 'mepr-inactive') !== false /*&& !$prd->is_renewable()*/) {
                ...
                <tr x-data="{open:false}">
                    <td class="th_td-membership"  data-label="<?php _ex('Membership', 'ui', 'memberpress'); ?>">
                    ...
                    <td class="th_td-terms"  data-label="<?php _ex('Terms', 'ui', 'memberpress'); ?>">
                        <?php if ($prd->register_price_action != 'hidden'): ?>
                            <div class="mepr-pro-account-terms">
                                <?php
                                if ($txn != false && $txn instanceof MeprTransaction && $txn->is_sub_account()) {
                    ...
                    <td class="th_td-status"  data-label="<?php _ex('Status', 'ui', 'memberpress'); ?>">
                        <?php
