...
<?php if (!empty($welcome_message)) : ?>
    <div
        class="mepr-account-message mepr-account-welcome-message <?php echo $welcome_image ? 'has-welcome-image' : '' ?>"><?php echo $welcome_message ?></div>
<?php endif; ?>
...
<div class="mepr-profile-wrapper">
    <div id="mepr-profile-details">
        ...
        <dl class="mepr-profile-details__list">
            <dt class="_name">
                <div class="_group">
                    <span class="_heading"><?php echo esc_html_x('Name', 'ui', 'memberpress'); ?></span>
                    <div><?php echo esc_html($mepr_current_user->full_name()); ?></div>
                </div>
                <button data-name="name" class="mepr-profile-details__button btn btn-link">
                    <svg class="mepr-profile-details__icon" width="15" height="16" viewBox="0 0 15 16" fill="none"
            ...
            <dd class="mepr-profile-details__content dd_name"><?php echo esc_html($mepr_current_user->full_name()); ?></dd>

            <dt class="_email">
                <div class="_group">
                    <span class="_heading"><?php echo esc_html_x('Email', 'ui', 'memberpress'); ?></span>
                    <div><?php echo esc_html($mepr_current_user->user_email); ?></div>
                </div>
            ...
            <dd class="mepr-profile-details__content dd_email"><?php echo esc_html($mepr_current_user->user_email); ?></dd>

            <?php if ($mepr_options->show_address_fields) { ?>
            <dt class="_billing">
                <div class="_group">
                    <span class="_heading"><?php echo esc_html_x('Billing Address', 'ui', 'memberpress'); ?></span>
                    <div><?php echo wp_kses_post(implode(', ', $address_values)); ?></div>
                </div>
            ...
            <dd class="mepr-profile-details__content dd_billing">
                <?php echo wp_kses_post(implode(', ', $address_values)); ?>
            </dd>
            <?php } ?>
  ...
  */ ?>
            <a class="mepr-button btn-outline btn btn-outline"
                href="<?php echo esc_url_raw(MeprHooks::apply_filters('mepr-account-nav-change-password', $account_url . $delim . 'action=newpassword')); ?>"><?php echo esc_html_x('Change Password', 'ui', 'memberpress'); ?></a>
        </div>
    </div>
    ...
    <div class="mepr_modal__content_wrapper">
        <div class="mepr_modal__content">
            <div class="mepr_modal__box">
                ...
                <div>
                    ...
                    <form class="mepr_modal_form mepr-account-form mepr-form" action="" enctype="multipart/form-data"
                        novalidate>
                            ...
                            <div class="mp-form-row mepr_name">
                                ...
                                <div class="mp-form-row-group">
                                    <input type="text" name="user_first_name"
                                        id="user_first_name<?php echo $unique_suffix; ?>"
                                        class="mepr-form-input" value="<?php echo esc_attr($first_name_value); ?>"
                                        placeholder="<?php _ex('First Name', 'ui', 'memberpress');
                                        echo ($mepr_options->require_fname_lname) ? '*' : ''; ?>
      " <?php echo ($mepr_options->require_fname_lname) ? 'required' : ''; ?> />
                                    <input type="text" name="user_last_name"
                                        id="user_last_name<?php echo $unique_suffix; ?>"
                                        class="mepr-form-input" value="<?php echo esc_attr($last_name_value); ?>"
                                        placeholder="<?php _ex('Last Name', 'ui', 'memberpress');
                                        echo ($mepr_options->require_fname_lname) ? '*' : ''; ?>
      " <?php echo ($mepr_options->require_fname_lname) ? 'required' : ''; ?> />
                                </div>
      ...
      <?php
                        ...
                        <div class="mp-form-row mepr_email mepr-field-required">
                            <div class="mp-form-label">
                                <label
                                    for="user_email"><?php echo esc_html_x('Email:*', 'ui', 'memberpress'); ?></label>
                                <span
                                    class="cc-error"><?php echo esc_html_x('Invalid Email', 'ui', 'memberpress'); ?></span>
                            </div>
                            <input type="email" id="user_email" name="user_email" class="mepr-form-input"
                                value="<?php echo esc_attr($mepr_current_user->user_email); ?>" required/>
                        </div>

                        <div id="mp-address-group-label" class="mp-form-label">
                            <label
                                for="billing_address"><?php echo esc_html_x('Change your billing address:*', 'ui', 'memberpress'); ?></label>
                        </div>
                        ...
                        <input class="btn btn-primary" type="submit"
                            value="<?php echo esc_html_x('Save Changes', 'ui', 'memberpress'); ?>">
                    </form>
                </div>
            </div>
        </div>
